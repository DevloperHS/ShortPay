...
- **Completed Hours**: Integer floor division of billable dwell (`(dwell - free time) // 60`) for detention billing.
...
- **Frontend**: Vite React SPA in `frontend/web/`, served by a Flask BFF in `frontend/`.
